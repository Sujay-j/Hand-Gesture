# -*- coding: utf-8 -*-
"""
Created on Thu Oct 22 22:59:17 2020
...
while capture.isOpened():
    ...
    kernal = np.ones((5,5))
    dialation = cv2.dilate(mask2,kernal,iterations = 1)
    erosion = cv2.erode(dialation,kernal,iterations = 1)
    ...
    try:
        ...
        cv2.drawContours(drawing,[contour],-1,(255,0,255),0)
        ...
        for i in range(defects.shape[0]):
            ...
            if angle <= 90:
                count_defects += 1
                cv2.circle(crop_image,far,1,[0,255,255],-1)
            cv2.line(crop_image,start,end,[0,255,255],2)
        if count_defects == 0:
